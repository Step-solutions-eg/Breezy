...
## Corpus Check
- 37 files · ~706,952 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 362 nodes · 344 edges · 35 communities (23 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eedba37a`
...
Cohesion: 0.14
Nodes (13): Article Cards, Button-in-Button CTA, Colors, Components, Do's and Don'ts, Double-Bezel (Doppelrand) Cards, Elevation & Depth, Fluid Island Navbar (+5 more)
...
## Knowledge Gaps
- **243 isolated node(s):** `$schema`, `plugin`, `@opencode-ai/plugin`, `containerVariants`, `cardVariants` (+238 more)
